...
# In this example, let's assume we want to drop rows where 'ord_no' or 'purch_amt' have missing values
df_cleaned = df.dropna(subset=['ord_no', 'purch_amt'])

print("DataFrame after dropping rows with missing values in 'ord_no' or 'purch_amt' columns:")
print(df_cleaned)

"""Output:
DataFrame after dropping rows with missing values in 'ord_no' or 'purch_amt' columns:
